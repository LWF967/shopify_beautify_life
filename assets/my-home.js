...
window.onload = function() {
    ...
    let flag = false;
 var toggleButtonAddAddress =  document.querySelector(".add_address")
//  console.log(add_address);
 toggleButtonAddAddress.addEventListener('click',function(e){
   e.stopPropagation();
   if(!flag){
    toggleButtonAddAddress.setAttribute('aria-expanded',true)
   flag = true;
   }else{
    toggleButtonAddAddress.setAttribute('aria-expanded',false)
    flag =false;
   }
 })
...
//     flag =false;
//  })
//  var editButton = document.getElementById('EditFormButton_{{ address.id}}')
