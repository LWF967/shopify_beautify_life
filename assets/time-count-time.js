  ...
  function time(){
    ...
    if( count_time<=0){
      ...
      set_time_day.innerHTML = parseInt(count_time/(3600*24));
      set_time_minutes.innerHTML = parseInt(count_time/3600%24);
      set_time_second.innerHTML = parseInt(count_time/60%60);
      set_time_millisecond.innerHTML = parseInt(count_time%60);
